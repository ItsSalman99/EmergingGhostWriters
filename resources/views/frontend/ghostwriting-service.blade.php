                ...
                <div class="row align-items-center">
                    <div class="col-md-8">
                        <div class="page-title mb-30">
                            ...
                            <h3>{{ $ghostwritingservice->name }}</h3>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="breadcrumb-list mb-30">
                            <ul>
                                <li><a href="index.html">ghostwritingservices</a></li>
                                <li>{{ $ghostwritingservice->name }}</li>
                            </ul>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="td-bottom-content">
                            <h3 class="title">About {{ $ghostwritingservice->name }}</h3>
                            <div class="text mb-45">
                                ...
                                <p>He is a ghostwritingservices industry veteran with a diversified wealth of expertise that includes
                            ...
                            <div class="text mb-30">
                                <p>Prior to joining Ozix, he spent 20+ years at Inmosys, where he held a wide range of
                                    global leadership roles, from ghostwritingservices to products, and across operations and sales.
                                    ...
                                    Digital Product Engineering ghostwritingservices leader helping Fortune 500 companies on their
        ...
        <section class="team-area pt-120 pb-90">
            <div class="container">
                <div class="section-title-2 text-center">
                    ...
                    <h2>{{ $ghostwritingservice->name }}</h2>
                </div>
                <div class="row">
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="team-single text-center mb-30">
                            <div class="team-text mb-35">
                                <h3><a href="team-details.html">Personalized <br> ghostwritingservice</a></h3>
                                <hr>
                                <p>Lorem ipsum, dolor sit amet consectetur adipisicing elit.</p>
                                <br>
                            </div>
