        ...
        <div class="container">
            ...
            <div class="row justify-content-center m-2">
                <div class="col text-center p-2">
                    <img style="width: 50%; margin: 0 auto;" src="{{ asset('assets/frontend/img/brand/amazon.png') }}" alt="amazon">
                </div>
                <div class="col text-center p-2">
                    <img style="width: 50%; margin: 0 auto;" src="{{ asset('assets/frontend/img/brand/barnesnoble.png') }}" alt="amazon">
                </div>
                <div class="col text-center p-2">
                    <img style="width: 50%; margin: 0 auto;" src="{{ asset('assets/frontend/img/brand/createspace.png') }}" alt="amazon">
                </div>
                <div class="col text-center p-2">
                    <img style="width: 50%; margin: 0 auto;" src="{{ asset('assets/frontend/img/brand/googlebooks.png') }}" alt="amazon">
                </div>
            </div>
            <div class="row justify-content-center m-2">
                <div class="col text-center p-2">
                    <img style="width: 50%; margin: 0 auto;" src="{{ asset('assets/frontend/img/brand/draft2digital.png') }}" alt="amazon">
                </div>
                <div class="col text-center p-2">
                    <img style="width: 50%; margin: 0 auto;" src="{{ asset('assets/frontend/img/brand/indigo.png') }}" alt="amazon">
                </div>
                <div class="col text-center p-2">
                    <img style="width: 50%; margin: 0 auto;" src="{{ asset('assets/frontend/img/brand/ingramspark.png') }}" alt="amazon">
                </div>
                <div class="col text-center p-2">
                    <img style="width: 50%; margin: 0 auto;" src="{{ asset('assets/frontend/img/brand/kobo.png') }}" alt="amazon">
                </div>
            </div>
            <div class="row justify-content-center m-2">
                <div class="col text-center p-2">
                    <img style="width: 40%; margin: 0 auto;" src="{{ asset('assets/frontend/img/brand/lulu.png') }}" alt="amazon">
                </div>
                <div class="col text-center p-2">
                    <img style="width: 40%; margin: 0 auto;" src="{{ asset('assets/frontend/img/brand/scribd.png') }}" alt="amazon">
                </div>
                <div class="col text-center p-2">
                    <img style="width: 40%; margin: 0 auto;" src="{{ asset('assets/frontend/img/brand/smashwords.png') }}" alt="amazon">
                </div>
            </div>
        </div>
    </section>
